...
from opentrade.models.trade import Trade, TradeAction, TradeSide, TradeStatus, CloseReason
from opentrade.models.position import Position, PositionSide, PositionStatus
...
class TradeExecutor:
    ...
    async def _get_decision(self, symbol: str) -> Optional[TradeDecision]:
        """获取交易决策"""
